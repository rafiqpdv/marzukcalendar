...
const MarzukCalendar = () => {
  ...
  const exportToPDF = () => {
    ...
    doc.autoTable({
      startY: 65,
      head: [['Photographer', 'Date', 'Time', 'Company', 'Contact', 'Amount', 'Balance', 'Status', 'Payment']],
      body: tableData,
      theme: 'striped',
      ...
      {showReportModal && (
        <div style={{
          ...
          <div style={{
            ...
            {/* Filter section omitted for brevity - same as before */}
            ...
            {/* Stats and table - same as before */}
          </div>
        </div>
      )}
